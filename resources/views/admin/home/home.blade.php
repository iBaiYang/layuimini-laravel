        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;">{{$info['username']}}</a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" layuimini-content-href="{{route('admin_user_setting')}}" data-title="基本资料" data-icon="fa fa-gears">基本资料<span class="layui-badge-dot"></span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;" layuimini-content-href="{{route('admin_user_password')}}" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        $('.login-out').on("click", function () {
            $.post('{{route('admin_login_out')}}', {_token:'{{csrf_token()}}'}, function (ret) {
                ret = JSON.parse(ret);
                if (!ret.code) {
                    layer.alert(ret.msg);
                    return false;
