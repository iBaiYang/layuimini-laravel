    ...
    <div class="layuimini-main">
        <div class="layui-form layuimini-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="again_password" lay-verify="required" lay-reqtext="确认密码不能为空" placeholder="请再次输入新的密码"  value="" class="layui-input">
                </div>
            </div>
...
<script>
    layui.use(['form','miniTab'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.post('{{route('admin_user_password')}}', $.parseJSON(JSON.stringify(data.field)), function (ret) {
                ret = JSON.parse(ret);
                if (ret.code) {
                    layer.alert(ret.msg);
                    return false;
